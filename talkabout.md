...
9 июля 2019 г.
- Количества кода и сложность программных продуктов; коммерсанты и спекулянты, искусственно завышающие стоимость этих продуктов + менеджеры в доле, обладающие административным ресурсом... - всё это приводит к появлению на новом витке развития цивилизации в современном информационно-электронном обществе такого понятия - как бюрократия-2. Это когда люди внизу (кодеры, сис/сете/девопс/админы) готовы делать всё, что угодно  - лишь бы платили больше. А эффективность всего этого значение уже мало для кого имеет. Поэтому мой выбор - это встраиваемая электроника, и оптимизация робототехники.
